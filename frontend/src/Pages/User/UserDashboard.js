      ...
      {token ? (
        <div className="flex h-screen bg-gradient-to-r from-teal-50 to-teal-200 ">
          <div className="flex flex-col justify-center items-start p-8 w-1/2 ">
            <h1 className="text-8xl font-bold text-left mb-8 ml-48 text-gray-500">
              Hello, <span className="text-9xl text-teal-500 ">{userName}</span>
            </h1>
            <h2 className="text-6xl text-left mb-8 ml-48 text-gray-500">
          ...
          <div className="flex flex-col justify-center items-center space-y-8 p-8 w-1/2">
            <div className="w-96 h-56 bg-cover bg-center rounded-md shadow-md cursor-pointer transform transition duration-300 hover:scale-105">
              ...
              <Link
                to="/userQuiz"
                className="absolute top-0 left-0 w-full h-full flex items-center justify-center text-white text-2xl font-semibold"
              >
                Take Quiz
              </Link>
            </div>
